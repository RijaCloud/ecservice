        ...
        findMapAndReloadMarkers : function(url,url2) {
            ...
            http.onreadystatechange = function() {
                ...
                if(http.readyState == 4 && http.status == 200) {
                     ...
                     var latitude = loaded_map.lieu ? loaded_map.lieu.latitude : loaded_map.latitude ;
                     var longitude = loaded_map.lieu ? loaded_map.lieu.longitude : loaded_map.longitude ;
                    ...
                    map_name.value = loaded_map.lieu ? loaded_map.lieu.string_lieu : loaded_map.nom;
                    map_description.value = loaded_map.lieu ? loaded_map.lieu.description : loaded_map.description;
